...
import com.marisma.practica3_2024.databinding.FragmentUserInfoBinding
...
class UserInfoFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.tvCreditTittle.typeface = ResourcesCompat.getFont(requireContext(), R.font.font_momentz)
        binding.tvUserName.typeface = ResourcesCompat.getFont(requireContext(), R.font.font_momentz)
        binding.tvFavCount.typeface = ResourcesCompat.getFont(requireContext(), R.font.font_momentz)
        binding.btnReturn.typeface = ResourcesCompat.getFont(requireContext(), R.font.font_momentz)
    }
    ...
    private fun obtenerFavoritos(): String {
        return songProvider.favouriteSongs.size.toString()
    }
}