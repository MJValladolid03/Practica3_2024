...
import com.marisma.practica3_2024.databinding.FragmentMenuBinding
...
class MenuFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.btnCatalog.typeface = ResourcesCompat.getFont(requireContext(), R.font.momentz)
        binding.btnSongs.typeface = ResourcesCompat.getFont(requireContext(), R.font.momentz)
